...
// operate on it in a controlled manner.
    ...
    public:
        ...
        AudioBuffer2(size_t input_rate,
        ...
        AudioBuffer2(size_t input_num_frames,
                    size_t input_num_channels,
        ...
        AudioBuffer2(const AudioBuffer2 &) = delete;

        AudioBuffer2 &operator=(const AudioBuffer2 &) = delete;
        ...
        void CopyTo(AudioBuffer2 *buffer) const;
