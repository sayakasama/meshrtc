...
#  define HAVE_ISNAN
#  define HAVE_ISINF
#  if (!defined(__GNUC__) || __GNUC__ >= 4) && !defined(__ANDROID__) /* gcc 3 and earlier often refuse to compile _l functions */
#   define HAVE_STRTOD_L  // shangtao modify for android compile 20240702
#   define HAVE_SSCANF_L
#   define HAVE_LOCALE_H
#  endif
#  define HAVE_SOCKLEN_T
