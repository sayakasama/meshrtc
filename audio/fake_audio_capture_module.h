...
class FakeAudioCaptureModule : public webrtc::AudioDeviceModule,
 ...
 public:
  ...
  static const size_t kNumberSamples = 441;
  static const size_t kNumberBytesPerSample = sizeof(Sample); // 16bit = 2byte

  // Creates a FakeAudioCaptureModule or returns NULL on failure.
  static rtc::scoped_refptr<FakeAudioCaptureModule> Create(bool file_io, int samples);
 ...
 private:
  ...
  webrtc::Mutex mutex_callback_;
  
  int av_rtp_session_id;
};
